...
var orderStore = /** @class */ (function () {
    ...
    orderStore.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connect = _a.sent();
                        sql = "INSERT INTO Orders (quantity, user_id, status) VALUES (".concat(data.quantity, ", ").concat(data.user_id, ", '").concat(data.status, "') RETURNING *;");
                        return [4 /*yield*/, connect.query(sql)];
                    case 2:
                        res = _a.sent();
                        // Closes the database connection
